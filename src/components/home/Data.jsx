    ...
    return (
        <div className="home__data">
            ...
            <p className="home__description">
                I'm Soumya Ranjan Hembram, a dedicated Web and App developer with expertise in both front-end and back-end development. I specialize in creating innovative, user-friendly digital solutions.
            </p>
